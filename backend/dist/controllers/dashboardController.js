...
exports.getStatsEvolutionOverTime = exports.getRarityAnalysis = exports.getTopPokemonByStat = exports.getEvolutionDistribution = exports.getTypeDistribution = void 0;
...
const getStatsEvolutionOverTime = async (req, res) => {
    try {
        // Group Pokemon by their fetchedAt date (hourly batches)
        const statsEvolution = await Pokemon_1.default.aggregate([
            {
                $group: {
                    _id: {
                        year: { $year: '$fetchedAt' },
...
exports.getStatsEvolutionOverTime = getStatsEvolutionOverTime;
